...
: ${AMENT_CURRENT_PREFIX:="/home/omid/data/colcon_ws1FW/src/final_work/src/install/integrated_system"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/integrated_system/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/integrated_system/environment/path.sh"
