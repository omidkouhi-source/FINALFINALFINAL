...
robotiq_85_gripper_server__srv__GripperOpen_Request__create(void)
{
  ...
  robotiq_85_gripper_server__srv__GripperOpen_Request * msg = (robotiq_85_gripper_server__srv__GripperOpen_Request *)allocator.allocate(sizeof(robotiq_85_gripper_server__srv__GripperOpen_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotiq_85_gripper_server__srv__GripperOpen_Request));
  bool success = robotiq_85_gripper_server__srv__GripperOpen_Request__init(msg);
  if (!success) {
...
robotiq_85_gripper_server__srv__GripperOpen_Request__destroy(robotiq_85_gripper_server__srv__GripperOpen_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robotiq_85_gripper_server__srv__GripperOpen_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__init(robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Request * data = NULL;

  if (size) {
    data = (robotiq_85_gripper_server__srv__GripperOpen_Request *)allocator.zero_allocate(size, sizeof(robotiq_85_gripper_server__srv__GripperOpen_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotiq_85_gripper_server__srv__GripperOpen_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        robotiq_85_gripper_server__srv__GripperOpen_Request__fini(&data[i - 1]);
      }
...
robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__fini(robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      robotiq_85_gripper_server__srv__GripperOpen_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * array = (robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence *)allocator.allocate(sizeof(robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__init(array, size);
  if (!success) {
...
robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__destroy(robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__are_equal(const robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * lhs, const robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotiq_85_gripper_server__srv__GripperOpen_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotiq_85_gripper_server__srv__GripperOpen_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotiq_85_gripper_server__srv__GripperOpen_Request * data =
      (robotiq_85_gripper_server__srv__GripperOpen_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotiq_85_gripper_server__srv__GripperOpen_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotiq_85_gripper_server__srv__GripperOpen_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotiq_85_gripper_server__srv__GripperOpen_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Response * msg = (robotiq_85_gripper_server__srv__GripperOpen_Response *)allocator.allocate(sizeof(robotiq_85_gripper_server__srv__GripperOpen_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotiq_85_gripper_server__srv__GripperOpen_Response));
  bool success = robotiq_85_gripper_server__srv__GripperOpen_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotiq_85_gripper_server__srv__GripperOpen_Response__destroy(robotiq_85_gripper_server__srv__GripperOpen_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    robotiq_85_gripper_server__srv__GripperOpen_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__init(robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Response * data = NULL;

  if (size) {
    data = (robotiq_85_gripper_server__srv__GripperOpen_Response *)allocator.zero_allocate(size, sizeof(robotiq_85_gripper_server__srv__GripperOpen_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotiq_85_gripper_server__srv__GripperOpen_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotiq_85_gripper_server__srv__GripperOpen_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__fini(robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotiq_85_gripper_server__srv__GripperOpen_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * array = (robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence *)allocator.allocate(sizeof(robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__destroy(robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__are_equal(const robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * lhs, const robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotiq_85_gripper_server__srv__GripperOpen_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotiq_85_gripper_server__srv__GripperOpen_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotiq_85_gripper_server__srv__GripperOpen_Response * data =
      (robotiq_85_gripper_server__srv__GripperOpen_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotiq_85_gripper_server__srv__GripperOpen_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotiq_85_gripper_server__srv__GripperOpen_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotiq_85_gripper_server__srv__GripperOpen_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
robotiq_85_gripper_server__srv__GripperOpen_Event__init(robotiq_85_gripper_server__srv__GripperOpen_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    robotiq_85_gripper_server__srv__GripperOpen_Event__fini(msg);
    return false;
  }
  // request
  if (!robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__init(&msg->request, 0)) {
    robotiq_85_gripper_server__srv__GripperOpen_Event__fini(msg);
    return false;
  }
  // response
  if (!robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__init(&msg->response, 0)) {
    robotiq_85_gripper_server__srv__GripperOpen_Event__fini(msg);
    return false;
  }
  return true;
...
robotiq_85_gripper_server__srv__GripperOpen_Event__fini(robotiq_85_gripper_server__srv__GripperOpen_Event * msg)
{
  ...
  // request
  robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__fini(&msg->request);
  // response
  robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__fini(&msg->response);
}
...
robotiq_85_gripper_server__srv__GripperOpen_Event__are_equal(const robotiq_85_gripper_server__srv__GripperOpen_Event * lhs, const robotiq_85_gripper_server__srv__GripperOpen_Event * rhs)
{
  ...
  // request
  if (!robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__are_equal(
  ...
  robotiq_85_gripper_server__srv__GripperOpen_Event * output)
{
  ...
  // request
  if (!robotiq_85_gripper_server__srv__GripperOpen_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!robotiq_85_gripper_server__srv__GripperOpen_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Event * msg = (robotiq_85_gripper_server__srv__GripperOpen_Event *)allocator.allocate(sizeof(robotiq_85_gripper_server__srv__GripperOpen_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(robotiq_85_gripper_server__srv__GripperOpen_Event));
  bool success = robotiq_85_gripper_server__srv__GripperOpen_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence__init(robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Event * data = NULL;

  if (size) {
    data = (robotiq_85_gripper_server__srv__GripperOpen_Event *)allocator.zero_allocate(size, sizeof(robotiq_85_gripper_server__srv__GripperOpen_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = robotiq_85_gripper_server__srv__GripperOpen_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        robotiq_85_gripper_server__srv__GripperOpen_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence__fini(robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      robotiq_85_gripper_server__srv__GripperOpen_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * array = (robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence *)allocator.allocate(sizeof(robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence__destroy(robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence__are_equal(const robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * lhs, const robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!robotiq_85_gripper_server__srv__GripperOpen_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  robotiq_85_gripper_server__srv__GripperOpen_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(robotiq_85_gripper_server__srv__GripperOpen_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    robotiq_85_gripper_server__srv__GripperOpen_Event * data =
      (robotiq_85_gripper_server__srv__GripperOpen_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!robotiq_85_gripper_server__srv__GripperOpen_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          robotiq_85_gripper_server__srv__GripperOpen_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!robotiq_85_gripper_server__srv__GripperOpen_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
