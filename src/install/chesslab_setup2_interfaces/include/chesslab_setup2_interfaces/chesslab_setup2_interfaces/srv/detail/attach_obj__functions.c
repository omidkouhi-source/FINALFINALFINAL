...
chesslab_setup2_interfaces__srv__AttachObj_Request__create(void)
{
  ...
  chesslab_setup2_interfaces__srv__AttachObj_Request * msg = (chesslab_setup2_interfaces__srv__AttachObj_Request *)allocator.allocate(sizeof(chesslab_setup2_interfaces__srv__AttachObj_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chesslab_setup2_interfaces__srv__AttachObj_Request));
  bool success = chesslab_setup2_interfaces__srv__AttachObj_Request__init(msg);
  if (!success) {
...
chesslab_setup2_interfaces__srv__AttachObj_Request__destroy(chesslab_setup2_interfaces__srv__AttachObj_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    chesslab_setup2_interfaces__srv__AttachObj_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__init(chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Request * data = NULL;

  if (size) {
    data = (chesslab_setup2_interfaces__srv__AttachObj_Request *)allocator.zero_allocate(size, sizeof(chesslab_setup2_interfaces__srv__AttachObj_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chesslab_setup2_interfaces__srv__AttachObj_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        chesslab_setup2_interfaces__srv__AttachObj_Request__fini(&data[i - 1]);
      }
...
chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__fini(chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      chesslab_setup2_interfaces__srv__AttachObj_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * array = (chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence *)allocator.allocate(sizeof(chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__init(array, size);
  if (!success) {
...
chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__destroy(chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__are_equal(const chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * lhs, const chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!chesslab_setup2_interfaces__srv__AttachObj_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(chesslab_setup2_interfaces__srv__AttachObj_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    chesslab_setup2_interfaces__srv__AttachObj_Request * data =
      (chesslab_setup2_interfaces__srv__AttachObj_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!chesslab_setup2_interfaces__srv__AttachObj_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          chesslab_setup2_interfaces__srv__AttachObj_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!chesslab_setup2_interfaces__srv__AttachObj_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Response * msg = (chesslab_setup2_interfaces__srv__AttachObj_Response *)allocator.allocate(sizeof(chesslab_setup2_interfaces__srv__AttachObj_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chesslab_setup2_interfaces__srv__AttachObj_Response));
  bool success = chesslab_setup2_interfaces__srv__AttachObj_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
chesslab_setup2_interfaces__srv__AttachObj_Response__destroy(chesslab_setup2_interfaces__srv__AttachObj_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    chesslab_setup2_interfaces__srv__AttachObj_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__init(chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Response * data = NULL;

  if (size) {
    data = (chesslab_setup2_interfaces__srv__AttachObj_Response *)allocator.zero_allocate(size, sizeof(chesslab_setup2_interfaces__srv__AttachObj_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chesslab_setup2_interfaces__srv__AttachObj_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        chesslab_setup2_interfaces__srv__AttachObj_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__fini(chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      chesslab_setup2_interfaces__srv__AttachObj_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * array = (chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence *)allocator.allocate(sizeof(chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__destroy(chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__are_equal(const chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * lhs, const chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!chesslab_setup2_interfaces__srv__AttachObj_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(chesslab_setup2_interfaces__srv__AttachObj_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    chesslab_setup2_interfaces__srv__AttachObj_Response * data =
      (chesslab_setup2_interfaces__srv__AttachObj_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!chesslab_setup2_interfaces__srv__AttachObj_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          chesslab_setup2_interfaces__srv__AttachObj_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!chesslab_setup2_interfaces__srv__AttachObj_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
chesslab_setup2_interfaces__srv__AttachObj_Event__init(chesslab_setup2_interfaces__srv__AttachObj_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    chesslab_setup2_interfaces__srv__AttachObj_Event__fini(msg);
    return false;
  }
  // request
  if (!chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__init(&msg->request, 0)) {
    chesslab_setup2_interfaces__srv__AttachObj_Event__fini(msg);
    return false;
  }
  // response
  if (!chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__init(&msg->response, 0)) {
    chesslab_setup2_interfaces__srv__AttachObj_Event__fini(msg);
    return false;
  }
  return true;
...
chesslab_setup2_interfaces__srv__AttachObj_Event__fini(chesslab_setup2_interfaces__srv__AttachObj_Event * msg)
{
  ...
  // request
  chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__fini(&msg->request);
  // response
  chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__fini(&msg->response);
}
...
chesslab_setup2_interfaces__srv__AttachObj_Event__are_equal(const chesslab_setup2_interfaces__srv__AttachObj_Event * lhs, const chesslab_setup2_interfaces__srv__AttachObj_Event * rhs)
{
  ...
  // request
  if (!chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__are_equal(
  ...
  chesslab_setup2_interfaces__srv__AttachObj_Event * output)
{
  ...
  // request
  if (!chesslab_setup2_interfaces__srv__AttachObj_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!chesslab_setup2_interfaces__srv__AttachObj_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Event * msg = (chesslab_setup2_interfaces__srv__AttachObj_Event *)allocator.allocate(sizeof(chesslab_setup2_interfaces__srv__AttachObj_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chesslab_setup2_interfaces__srv__AttachObj_Event));
  bool success = chesslab_setup2_interfaces__srv__AttachObj_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence__init(chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Event * data = NULL;

  if (size) {
    data = (chesslab_setup2_interfaces__srv__AttachObj_Event *)allocator.zero_allocate(size, sizeof(chesslab_setup2_interfaces__srv__AttachObj_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chesslab_setup2_interfaces__srv__AttachObj_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        chesslab_setup2_interfaces__srv__AttachObj_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence__fini(chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      chesslab_setup2_interfaces__srv__AttachObj_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * array = (chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence *)allocator.allocate(sizeof(chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence__destroy(chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence__are_equal(const chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * lhs, const chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!chesslab_setup2_interfaces__srv__AttachObj_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  chesslab_setup2_interfaces__srv__AttachObj_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(chesslab_setup2_interfaces__srv__AttachObj_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    chesslab_setup2_interfaces__srv__AttachObj_Event * data =
      (chesslab_setup2_interfaces__srv__AttachObj_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!chesslab_setup2_interfaces__srv__AttachObj_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          chesslab_setup2_interfaces__srv__AttachObj_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!chesslab_setup2_interfaces__srv__AttachObj_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
