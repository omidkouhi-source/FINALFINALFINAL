...
#ifndef CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__GET_PIECE_LOCATION__FUNCTIONS_H_
#define CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__GET_PIECE_LOCATION__FUNCTIONS_H_
...
/// Initialize srv/GetPieceLocation message.
/**
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Request__create()
...
/// Finalize srv/GetPieceLocation message.
/**
...
/// Create srv/GetPieceLocation message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Request__init().
...
/// Destroy srv/GetPieceLocation message.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Request__fini()
...
/// Check for srv/GetPieceLocation message equality.
/**
...
/// Copy a srv/GetPieceLocation message.
/**
...
/// Initialize array of srv/GetPieceLocation messages.
/**
...
/// Finalize array of srv/GetPieceLocation messages.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Request__fini()
...
/// Create array of srv/GetPieceLocation messages.
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetPieceLocation messages.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetPieceLocation message array equality.
/**
...
/// Copy an array of srv/GetPieceLocation messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__GetPieceLocation_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__GET_PIECE_LOCATION__FUNCTIONS_H_
