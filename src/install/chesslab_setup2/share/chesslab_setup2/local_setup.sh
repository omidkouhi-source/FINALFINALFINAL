...
: ${AMENT_CURRENT_PREFIX:="/home/omid/data/colcon_ws1FW/src/final_work/src/install/chesslab_setup2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chesslab_setup2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/chesslab_setup2/environment/path.sh"
