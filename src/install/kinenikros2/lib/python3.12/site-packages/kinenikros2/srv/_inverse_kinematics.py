...
class Metaclass_InverseKinematics_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('kinenikros2')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_InverseKinematics_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from kinenikros2.msg import InverseKinematics
            if InverseKinematics.__class__._TYPE_SUPPORT is None:
                InverseKinematics.__class__.__import_type_support__()
...
class InverseKinematics_Response(metaclass=Metaclass_InverseKinematics_Response):
    ...
    _fields_and_field_types = {
        'ik_solution': 'sequence<kinenikros2/InverseKinematics>',
        'status': 'boolean',
    }
    ...
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['kinenikros2', 'msg'], 'InverseKinematics')),  # noqa: E501
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, InverseKinematics) for v in value) and
                 True), \
                "The 'ik_solution' field must be a set or sequence and each value of type 'InverseKinematics'"
...
class InverseKinematics_Event(metaclass=Metaclass_InverseKinematics_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<kinenikros2/InverseKinematics_Request, 1>',
        'response': 'sequence<kinenikros2/InverseKinematics_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['kinenikros2', 'srv'], 'InverseKinematics_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['kinenikros2', 'srv'], 'InverseKinematics_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from kinenikros2.srv import InverseKinematics_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from kinenikros2.srv import InverseKinematics_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_InverseKinematics(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'kinenikros2.srv.InverseKinematics')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from kinenikros2.srv import _inverse_kinematics
...
class InverseKinematics(metaclass=Metaclass_InverseKinematics):
    from kinenikros2.srv._inverse_kinematics import InverseKinematics_Request as Request
    from kinenikros2.srv._inverse_kinematics import InverseKinematics_Response as Response
    from kinenikros2.srv._inverse_kinematics import InverseKinematics_Event as Event
