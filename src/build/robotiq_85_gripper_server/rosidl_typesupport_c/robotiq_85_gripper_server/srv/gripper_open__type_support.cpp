...
static const _GripperOpen_Request_type_support_symbol_names_t _GripperOpen_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_85_gripper_server, srv, GripperOpen_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_85_gripper_server, srv, GripperOpen_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_85_gripper_server, srv, GripperOpen_Request)() {
  return &::robotiq_85_gripper_server::srv::rosidl_typesupport_c::GripperOpen_Request_message_type_support_handle;
}
...
static const _GripperOpen_Response_type_support_symbol_names_t _GripperOpen_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_85_gripper_server, srv, GripperOpen_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_85_gripper_server, srv, GripperOpen_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_85_gripper_server, srv, GripperOpen_Response)() {
  return &::robotiq_85_gripper_server::srv::rosidl_typesupport_c::GripperOpen_Response_message_type_support_handle;
}
...
static const _GripperOpen_Event_type_support_symbol_names_t _GripperOpen_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_85_gripper_server, srv, GripperOpen_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_85_gripper_server, srv, GripperOpen_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_85_gripper_server, srv, GripperOpen_Event)() {
  return &::robotiq_85_gripper_server::srv::rosidl_typesupport_c::GripperOpen_Event_message_type_support_handle;
}
...
static const _GripperOpen_type_support_symbol_names_t _GripperOpen_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_85_gripper_server, srv, GripperOpen)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_85_gripper_server, srv, GripperOpen)),
  }
};
...
static const rosidl_service_type_support_t GripperOpen_service_type_support_handle = {
  ...
  &GripperOpen_Request_message_type_support_handle,
  &GripperOpen_Response_message_type_support_handle,
  &GripperOpen_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_85_gripper_server, srv, GripperOpen)() {
  return &::robotiq_85_gripper_server::srv::rosidl_typesupport_c::GripperOpen_service_type_support_handle;
}
