...
#include "kinenikros2/srv/detail/inverse_kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinenikros2::srv::InverseKinematics_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinenikros2::srv::InverseKinematics_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinenikros2::srv::InverseKinematics_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_kinenikros2
const rosidl_message_type_support_t *
get_message_type_support_handle<kinenikros2::srv::InverseKinematics_Request>()
{
  return &kinenikros2::srv::typesupport_fastrtps_cpp::_InverseKinematics_Request__handle;
}
...
{
bool cdr_serialize(
  const kinenikros2::msg::InverseKinematics &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  kinenikros2::msg::InverseKinematics &);
size_t get_serialized_size(
  const kinenikros2::msg::InverseKinematics &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ik_solution
  {
    ...
    for (size_t i = 0; i < size; i++) {
      kinenikros2::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  kinenikros2::srv::InverseKinematics_Response & ros_message)
{
  // Member: ik_solution
  {
    ...
    for (size_t i = 0; i < size; i++) {
      kinenikros2::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: ik_solution
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        kinenikros2::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: ik_solution
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kinenikros2::msg::typesupport_fastrtps_cpp::max_serialized_size_InverseKinematics(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kinenikros2::srv::InverseKinematics_Response;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ik_solution
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      kinenikros2::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.ik_solution[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: ik_solution
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        kinenikros2::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.ik_solution[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: ik_solution
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kinenikros2::msg::typesupport_fastrtps_cpp::max_serialized_size_key_InverseKinematics(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const kinenikros2::srv::InverseKinematics_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<kinenikros2::srv::InverseKinematics_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &kinenikros2::srv::typesupport_fastrtps_cpp::_InverseKinematics_Response__handle;
}
...
// functions for kinenikros2::srv::InverseKinematics_Request already declared above

// functions for kinenikros2::srv::InverseKinematics_Response already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      kinenikros2::srv::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  kinenikros2::srv::InverseKinematics_Event & ros_message)
{
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      kinenikros2::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        kinenikros2::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kinenikros2::srv::typesupport_fastrtps_cpp::max_serialized_size_InverseKinematics_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kinenikros2::srv::typesupport_fastrtps_cpp::max_serialized_size_InverseKinematics_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kinenikros2::srv::InverseKinematics_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      kinenikros2::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        kinenikros2::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kinenikros2::srv::typesupport_fastrtps_cpp::max_serialized_size_key_InverseKinematics_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        kinenikros2::srv::typesupport_fastrtps_cpp::max_serialized_size_key_InverseKinematics_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const kinenikros2::srv::InverseKinematics_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<kinenikros2::srv::InverseKinematics_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &kinenikros2::srv::typesupport_fastrtps_cpp::_InverseKinematics_Event__handle;
}
...
static const rosidl_service_type_support_t _InverseKinematics__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<kinenikros2::srv::InverseKinematics_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<kinenikros2::srv::InverseKinematics_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<kinenikros2::srv::InverseKinematics_Event>(),
...
{
  return &kinenikros2::srv::typesupport_fastrtps_cpp::_InverseKinematics__handle;
}
