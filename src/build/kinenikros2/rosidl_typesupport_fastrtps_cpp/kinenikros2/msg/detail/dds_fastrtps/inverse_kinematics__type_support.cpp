...
#include "kinenikros2/msg/detail/inverse_kinematics__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinenikros2::msg::InverseKinematics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinenikros2::msg::InverseKinematics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinenikros2::msg::InverseKinematics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _InverseKinematics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const kinenikros2::msg::InverseKinematics *>(
...
static size_t _InverseKinematics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_InverseKinematics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _InverseKinematics__callbacks = {
  "kinenikros2::msg",
  "InverseKinematics",
...
static rosidl_message_type_support_t _InverseKinematics__handle = {
...
{
  return &kinenikros2::msg::typesupport_fastrtps_cpp::_InverseKinematics__handle;
}
