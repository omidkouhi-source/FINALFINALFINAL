...
bool cdr_serialize_aruco_msgs__msg__Marker(
  const aruco_msgs__msg__Marker * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_aruco_msgs__msg__Marker(
  eprosima::fastcdr::Cdr & cdr,
  aruco_msgs__msg__Marker * ros_message);
...
bool cdr_serialize_key_aruco_msgs__msg__Marker(
  const aruco_msgs__msg__Marker * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_aruco_msgs__msg__Marker(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_aruco_msgs__msg__Marker(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: markers
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_aruco_msgs__msg__Marker(
        &array_ptr[i], cdr);
    }
  }
  ...
  aruco_msgs__msg__MarkerArray * ros_message)
{
  ...
  // Field name: markers
  {
    ...
    auto array_ptr = ros_message->markers.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_aruco_msgs__msg__Marker(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_msgs__msg__MarkerArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: markers
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_aruco_msgs__msg__Marker(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: markers
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_aruco_msgs__msg__Marker(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: markers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_aruco_msgs__msg__Marker(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const aruco_msgs__msg__MarkerArray * ros_message = static_cast<const aruco_msgs__msg__MarkerArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_aruco_msgs__msg__MarkerArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  aruco_msgs__msg__MarkerArray * ros_message = static_cast<aruco_msgs__msg__MarkerArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_aruco_msgs__msg__MarkerArray(cdr, ros_message);
}
