  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aruco_msgs__msg__Marker;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const aruco_msgs__msg__Marker * ros_message = static_cast<const aruco_msgs__msg__Marker *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_aruco_msgs__msg__Marker(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  aruco_msgs__msg__Marker * ros_message = static_cast<aruco_msgs__msg__Marker *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_aruco_msgs__msg__Marker(cdr, ros_message);
}
