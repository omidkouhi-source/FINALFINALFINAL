...
static const _GetPieceLocation_Request_type_support_symbol_names_t _GetPieceLocation_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Request)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::GetPieceLocation_Request_message_type_support_handle;
}
...
static const _GetPieceLocation_Response_type_support_symbol_names_t _GetPieceLocation_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Response)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::GetPieceLocation_Response_message_type_support_handle;
}
...
static const _GetPieceLocation_Event_type_support_symbol_names_t _GetPieceLocation_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, GetPieceLocation_Event)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::GetPieceLocation_Event_message_type_support_handle;
}
...
static const _GetPieceLocation_type_support_symbol_names_t _GetPieceLocation_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, GetPieceLocation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, GetPieceLocation)),
  }
};
...
static const rosidl_service_type_support_t GetPieceLocation_service_type_support_handle = {
  ...
  &GetPieceLocation_Request_message_type_support_handle,
  &GetPieceLocation_Response_message_type_support_handle,
  &GetPieceLocation_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, GetPieceLocation)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::GetPieceLocation_service_type_support_handle;
}
