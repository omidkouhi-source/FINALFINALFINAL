...
static const _SetObjPose_Request_type_support_symbol_names_t _SetObjPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, SetObjPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, SetObjPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, SetObjPose_Request)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::SetObjPose_Request_message_type_support_handle;
}
...
static const _SetObjPose_Response_type_support_symbol_names_t _SetObjPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, SetObjPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, SetObjPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, SetObjPose_Response)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::SetObjPose_Response_message_type_support_handle;
}
...
static const _SetObjPose_Event_type_support_symbol_names_t _SetObjPose_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, SetObjPose_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, SetObjPose_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, SetObjPose_Event)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::SetObjPose_Event_message_type_support_handle;
}
...
static const _SetObjPose_type_support_symbol_names_t _SetObjPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, chesslab_setup2_interfaces, srv, SetObjPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, chesslab_setup2_interfaces, srv, SetObjPose)),
  }
};
...
static const rosidl_service_type_support_t SetObjPose_service_type_support_handle = {
  ...
  &SetObjPose_Request_message_type_support_handle,
  &SetObjPose_Response_message_type_support_handle,
  &SetObjPose_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, chesslab_setup2_interfaces, srv, SetObjPose)() {
  return &::chesslab_setup2_interfaces::srv::rosidl_typesupport_c::SetObjPose_service_type_support_handle;
}
