...
#ifndef CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__VALIDATE_CHESS_ACTION__FUNCTIONS_H_
#define CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__VALIDATE_CHESS_ACTION__FUNCTIONS_H_
...
/// Initialize srv/ValidateChessAction message.
/**
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Request__create()
...
/// Finalize srv/ValidateChessAction message.
/**
...
/// Create srv/ValidateChessAction message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Request__init().
...
/// Destroy srv/ValidateChessAction message.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Request__fini()
...
/// Check for srv/ValidateChessAction message equality.
/**
...
/// Copy a srv/ValidateChessAction message.
/**
...
/// Initialize array of srv/ValidateChessAction messages.
/**
...
/// Finalize array of srv/ValidateChessAction messages.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Request__fini()
...
/// Create array of srv/ValidateChessAction messages.
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ValidateChessAction messages.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ValidateChessAction message array equality.
/**
...
/// Copy an array of srv/ValidateChessAction messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__ValidateChessAction_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__VALIDATE_CHESS_ACTION__FUNCTIONS_H_
