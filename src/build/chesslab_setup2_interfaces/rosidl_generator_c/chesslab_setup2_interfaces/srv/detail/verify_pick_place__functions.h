...
#ifndef CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__VERIFY_PICK_PLACE__FUNCTIONS_H_
#define CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__VERIFY_PICK_PLACE__FUNCTIONS_H_
...
/// Initialize srv/VerifyPickPlace message.
/**
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Request__create()
...
/// Finalize srv/VerifyPickPlace message.
/**
...
/// Create srv/VerifyPickPlace message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Request__init().
...
/// Destroy srv/VerifyPickPlace message.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Request__fini()
...
/// Check for srv/VerifyPickPlace message equality.
/**
...
/// Copy a srv/VerifyPickPlace message.
/**
...
/// Initialize array of srv/VerifyPickPlace messages.
/**
...
/// Finalize array of srv/VerifyPickPlace messages.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Request__fini()
...
/// Create array of srv/VerifyPickPlace messages.
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/VerifyPickPlace messages.
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/VerifyPickPlace message array equality.
/**
...
/// Copy an array of srv/VerifyPickPlace messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chesslab_setup2_interfaces
...
/**
 * It calls
 * chesslab_setup2_interfaces__srv__VerifyPickPlace_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHESSLAB_SETUP2_INTERFACES__SRV__DETAIL__VERIFY_PICK_PLACE__FUNCTIONS_H_
