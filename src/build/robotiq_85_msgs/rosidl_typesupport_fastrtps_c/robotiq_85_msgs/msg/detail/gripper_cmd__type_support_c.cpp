...
bool cdr_serialize_robotiq_85_msgs__msg__GripperCmd(
  const robotiq_85_msgs__msg__GripperCmd * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
bool cdr_deserialize_robotiq_85_msgs__msg__GripperCmd(
  eprosima::fastcdr::Cdr & cdr,
  robotiq_85_msgs__msg__GripperCmd * ros_message)
{
  // Field name: emergency_release
  {
    uint8_t tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
bool cdr_serialize_key_robotiq_85_msgs__msg__GripperCmd(
  const robotiq_85_msgs__msg__GripperCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: emergency_release
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
size_t get_serialized_size_key_robotiq_85_msgs__msg__GripperCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperCmd__ros_msg_type * ros_message = static_cast<const _GripperCmd__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
size_t max_serialized_size_key_robotiq_85_msgs__msg__GripperCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robotiq_85_msgs__msg__GripperCmd * ros_message = static_cast<const robotiq_85_msgs__msg__GripperCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robotiq_85_msgs__msg__GripperCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robotiq_85_msgs__msg__GripperCmd * ros_message = static_cast<robotiq_85_msgs__msg__GripperCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robotiq_85_msgs__msg__GripperCmd(cdr, ros_message);
}
