...
bool cdr_serialize_robotiq_85_msgs__msg__GripperStat(
  const robotiq_85_msgs__msg__GripperStat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
bool cdr_deserialize_robotiq_85_msgs__msg__GripperStat(
  eprosima::fastcdr::Cdr & cdr,
  robotiq_85_msgs__msg__GripperStat * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
bool cdr_serialize_key_robotiq_85_msgs__msg__GripperStat(
  const robotiq_85_msgs__msg__GripperStat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
size_t get_serialized_size_key_robotiq_85_msgs__msg__GripperStat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GripperStat__ros_msg_type * ros_message = static_cast<const _GripperStat__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robotiq_85_msgs
size_t max_serialized_size_key_robotiq_85_msgs__msg__GripperStat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robotiq_85_msgs__msg__GripperStat * ros_message = static_cast<const robotiq_85_msgs__msg__GripperStat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robotiq_85_msgs__msg__GripperStat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robotiq_85_msgs__msg__GripperStat * ros_message = static_cast<robotiq_85_msgs__msg__GripperStat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robotiq_85_msgs__msg__GripperStat(cdr, ros_message);
}
