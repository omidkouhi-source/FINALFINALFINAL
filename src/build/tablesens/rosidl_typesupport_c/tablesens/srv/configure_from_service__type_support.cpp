...
static const _ConfigureFromService_Request_type_support_symbol_names_t _ConfigureFromService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tablesens, srv, ConfigureFromService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tablesens, srv, ConfigureFromService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tablesens, srv, ConfigureFromService_Request)() {
  return &::tablesens::srv::rosidl_typesupport_c::ConfigureFromService_Request_message_type_support_handle;
}
...
static const _ConfigureFromService_Response_type_support_symbol_names_t _ConfigureFromService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tablesens, srv, ConfigureFromService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tablesens, srv, ConfigureFromService_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tablesens, srv, ConfigureFromService_Response)() {
  return &::tablesens::srv::rosidl_typesupport_c::ConfigureFromService_Response_message_type_support_handle;
}
...
static const _ConfigureFromService_Event_type_support_symbol_names_t _ConfigureFromService_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tablesens, srv, ConfigureFromService_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tablesens, srv, ConfigureFromService_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tablesens, srv, ConfigureFromService_Event)() {
  return &::tablesens::srv::rosidl_typesupport_c::ConfigureFromService_Event_message_type_support_handle;
}
...
static const _ConfigureFromService_type_support_symbol_names_t _ConfigureFromService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tablesens, srv, ConfigureFromService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tablesens, srv, ConfigureFromService)),
  }
};
...
static const rosidl_service_type_support_t ConfigureFromService_service_type_support_handle = {
  ...
  &ConfigureFromService_Request_message_type_support_handle,
  &ConfigureFromService_Response_message_type_support_handle,
  &ConfigureFromService_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tablesens, srv, ConfigureFromService)() {
  return &::tablesens::srv::rosidl_typesupport_c::ConfigureFromService_service_type_support_handle;
}
